...
Job titles are typically in <h2> tags with class 'title' and inside <a> tags within each job card.
Company names are always in <a> tags whose class contains 'gtmJobListingPostedBy'.
